...
def _build_mel_basis():
    ...
    print("hp.sample_rate",hp.sample_rate,"hp.n_fft",hp.n_fft,"n_mels",hp.num_mels,"fmin",hp.fmin,"fmax",hp.fmax)
    #return librosa.filters.mel(hp.sample_rate, hp.n_fft, n_mels=hp.num_mels, fmin=hp.fmin, fmax=hp.fmax)
    return librosa.filters.mel(hp.sample_rate, hp.n_fft, fmin=hp.fmin, n_mels=hp.num_mels)
